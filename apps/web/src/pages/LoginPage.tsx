...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-otto-midnight px-4">
      <div className="card w-full max-w-md">
        <div className="mb-6 flex items-center gap-3">
          <Shield className="h-10 w-10 text-otto-gold" />
          <div>
            <h1 className="font-display text-2xl font-bold tracking-wide">OTTO SYSTEM</h1>
