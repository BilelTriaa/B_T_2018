  ...
  return (
    <div className="flex min-h-screen">
      <aside className="flex w-64 flex-col border-r border-otto-border bg-otto-surface/50 p-4">
        <div className="mb-8">
          <div className="font-display text-xl font-bold tracking-wider text-otto-gold">OTTO</div>
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex items-center gap-2 rounded-lg px-3 py-2 text-sm transition ${
                    isActive ? 'bg-otto-gold/15 text-otto-gold' : 'text-otto-gray hover:bg-white/5 hover:text-white'
                  }`
                }
              >
                <Icon size={16} /> {label}
